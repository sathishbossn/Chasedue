...
export async function renderChaseDueInvoicePdf(
  ...
  currentY = 10
  const businessName = vm.seller.businessName || 'Your Business'
  ...
  doc.text('Generated by ChaseDue · chasedue.com', pageWidth / 2, footerY + 5, { align: 'center' })
  doc.text('This is a computer-generated invoice.', pageWidth / 2, footerY + 10, { align: 'center' })
