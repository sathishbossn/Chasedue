...
function InvoicePdfDocument({ data, logoUrl }: { data: InvoicePdfViewModel; logoUrl: string }) {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>Generated by ChaseDue · chasedue.com</Text>
          <Text style={styles.footerTiny}>This is a computer-generated invoice.</Text>
        </View>
      </Page>
    </Document>
  )
