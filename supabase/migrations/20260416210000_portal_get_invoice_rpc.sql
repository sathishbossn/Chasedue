-- Public portal: allow loading a single invoice by UUID using the anon key (no login).
-- The app calls this from the server-rendered /portal/[id] page via createPublicSupabaseAnonClient().
